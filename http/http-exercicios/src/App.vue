...
export default {
	...
	methods: {
		...
		obterUsuarios() {
			...
			/* Usando o axios localmente */
			// axios('https://curso-vue-beb1a.firebaseio.com/usuarios.json').then(res => {
			// 	this.usuarios = res.data
			// })

			/* Também podemos setar o header direto no método, após uma autenticação por exemplo */
